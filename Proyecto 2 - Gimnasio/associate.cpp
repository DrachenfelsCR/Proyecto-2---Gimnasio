...
associate::associate(string id, string full_name, string email, int phone, string registration_date, measurements* measures,instructor*,routine* exercises): person(id, full_name)
{
	this->email = email;
	this->phone = phone;
